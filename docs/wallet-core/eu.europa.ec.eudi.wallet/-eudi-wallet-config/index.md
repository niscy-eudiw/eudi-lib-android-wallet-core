...
| [configureIssuerTrust](configure-issuer-trust.md) | [androidJvm]<br>fun [configureIssuerTrust](configure-issuer-trust.md)(block: [IssuerTrustConfigBuilder](../../eu.europa.ec.eudi.wallet.trust/-issuer-trust-config-builder/index.md).() -&gt; [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-unit/index.html)): &lt;Error class: unknown class&gt;<br>Configure issuer trust verification for credentials issued via OpenID4VCI. Trust verification occurs after issuance, before storage. When not configured, trust verification is skipped entirely. |
