...
| [readerAuthPolicy](reader-auth-policy.md) | [androidJvm]<br>var [readerAuthPolicy](reader-auth-policy.md): ReaderAuthPolicy<br>The reader authentication enforcement policy for proximity and DCAPI presentations. This determines how the wallet handles reader authentication results when generating device responses. |
...
| [configureReaderAuthPolicy](configure-reader-auth-policy.md) | [androidJvm]<br>fun [configureReaderAuthPolicy](configure-reader-auth-policy.md)(readerAuthPolicy: ReaderAuthPolicy): &lt;Error class: unknown class&gt;<br>Configure the reader authentication enforcement policy. This policy controls how reader authentication results affect document disclosure during proximity and DCAPI presentations. |
