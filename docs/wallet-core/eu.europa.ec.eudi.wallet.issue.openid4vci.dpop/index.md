...
| [SecureAreaDpopSigner](-secure-area-dpop-signer/index.md) | [androidJvm]<br>class [SecureAreaDpopSigner](-secure-area-dpop-signer/index.md)(val config: [DPopConfig.Custom](-d-pop-config/-custom/index.md), algorithms: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin.collections/-list/index.html)&lt;Algorithm&gt;, logger: [Logger](../eu.europa.ec.eudi.wallet.logging/-logger/index.md)? = null) : [DPopSigner](-d-pop-signer/index.md)<br>Secure area-based implementation of [DPopSigner](-d-pop-signer/index.md) for OpenID4VCI credential issuance. |
